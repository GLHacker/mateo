...
export const storiesData = [
    {
        id: 1,
        title: 'Mateo y el Secreto de la Luna de Queso',
        image: storySpace,
        desc: 'Una aventura espacial donde Mateo descubre de qué está hecha realmente la luna.',
        content: `
...
Desde ese día, cada vez que Mateo mira la luna llena, le guiña un ojo, sabiendo que allí arriba, sus amigos están celebrando la fiesta más deliciosa del universo. Y aunque nadie más lo crea, él sabe el secreto: la luna, en su corazón, es del queso más dulce y mágico que existe.
    ...
    {
        id: 2,
        title: 'El Dinosaurio que Quería Ser Cantante',
        image: storyDino,
        desc: 'Tito el T-Rex tiene un sueño muy especial, pero su rugido es demasiado fuerte.',
        content: `
